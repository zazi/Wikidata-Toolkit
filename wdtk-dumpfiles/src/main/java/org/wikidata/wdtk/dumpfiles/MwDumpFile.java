...
public interface MwDumpFile {
	...
	class DateComparator implements Comparator<MwDumpFile> {
		...
		public int compare(MwDumpFile a, MwDumpFile b) {
			return a.getMetaData().getDateStamp()
					.compareTo(b.getMetaData().getDateStamp());
		}
	}

	/**
	 * Return the MetaData object which includes information about the project
	 * name, data stamp, etc.
	 * 
	 * @return
	 */
	public MwDumpFileMetaData getMetaData();
